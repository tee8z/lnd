...
type Chain struct {
	...
	SigNetBlockTime time.Duration `long:"signetblocktime" description:"Override the expected block interval for a custom signet network. This must match the signet node's signetblocktime setting."`
